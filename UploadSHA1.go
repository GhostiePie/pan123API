...
func (c *APIClient) UploadSHA1WithConfig(uploadSHA1Body UploadSHA1Body, config Config) (UploadSHA1Response, error) {
	url := config.Domain + config.UploadSHA1API
...
func (c *APIClient) UploadSHA1(uploadSHA1Body UploadSHA1Body) (UploadSHA1Response, error) {
	...
	return c.UploadSHA1WithConfig(uploadSHA1Body, config)
}
