...
func (c *APIClient) GetMultipleFilesDetailWithConfig(getMultipleFilesDetailBody GetMultipleFilesDetailBody, config Config) (GetMultipleFilesDetailResponse, error) {
...
func (c *APIClient) GetMultipleFilesDetail(getMultipleFilesDetailBody GetMultipleFilesDetailBody) (GetMultipleFilesDetailResponse, error) {
	config := GetDefaultConfig()
	return c.GetMultipleFilesDetailWithConfig(getMultipleFilesDetailBody, config)
}
