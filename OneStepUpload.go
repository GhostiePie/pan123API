...
func (c *APIClient) OneStepUploadWithConfig(oneStepUploadBody OneStepUploadBody, config Config) (OneStepUploadResponse, error) {
	url := config.Domain + config.OneStepUploadAPI
	body := &bytes.Buffer{}
...
func (c *APIClient) OneStepUpload(oneStepUploadBody OneStepUploadBody) (OneStepUploadResponse, error) {
	...
	return c.OneStepUploadWithConfig(oneStepUploadBody, config)
}
